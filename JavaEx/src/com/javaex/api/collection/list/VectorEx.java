...
public class VectorEx {
	...
	public static void main(String[] args) {
		...
		// 중간에 값을 넣기
		v.insertElementAt(100, 7); // 100을 7번 인덱스에 넣어 주세요
		System.out.println("v: "+ v);
		...
		v.removeElementAt(7); // 인덱스7의 요소 삭제
		System.out.println("v: " + v);
		
		v.setElementAt(100, 4); // 인덱스 4의 요소 100으로 변경 (Update)
		System.out.println("v: " + v);
