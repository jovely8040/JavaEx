...
//		stringMethodsEx();
	...
	private static void stringMethodsEx() {
		...
		System.out.println("3rd indexof Java: " + idx); // 더이상 검색어가 없으면 -1 
		idx = str.lastIndexOf("Java"); // 역방향 검색 
		System.out.println("역방향 검색: " + idx);
		
		// 문자열 추출
		System.out.println("substring 5 ~: " + str.substring(5)); // 5부터 끝까지
		System.out.println("substring 5 ~ 16: " + str.substring(5, 16)); // 5부터 16 앞까지 (15)
		...
		// 구분자로 분절
//		String[] split = str.split(" "); // 공백문자를 기준, 문자열 분절
		// 대문자, 콤마 없음, 분절 해주세요
